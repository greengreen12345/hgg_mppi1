...
class IsaacGymWrapper:
    ...
    def step(self, action):
        ...
        dis = self.goal_distance(obs['achieved_goal'], self.goal)
        ...
        return obs, reward, done, info, dis
    ...
    def reset(self):
        ...
        self.desired_goal = pre_pick_goal
    ...
    def _get_obs(self):
        ...
        return {
            ...
            'desired_goal': self.sampled_goal.cpu().numpy().copy()
        }
